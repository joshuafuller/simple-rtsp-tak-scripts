#Simple-RTSP-Server install for centos7 for use with TAK server
echo "simple-rtsp-server Setup Script CentOs7 - for use with TAK Server"
...
echo " "
echo "********************************************************************"
echo "Setup Script done, your Simple RTSP Server should now be running (check status above should see a green dot and Active)"
echo "********************************************************************"
echo " "
echo "********************************************************************"
